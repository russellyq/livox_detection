...
import tensorflow.contrib.slim as slim # tensorflow 1.15
...
class livox_model():
    ...
    def placeholder_inputs(self, batch_size):
        ...
        input_bev_img_pl = tf.placeholder(tf.int8, shape=(batch_size, self.img_height, self.img_width, self.channels))
